      ...
      <div class="marketing row">
        <?php foreach ($materialrelate as $item):?>
          <div class="col-lg-6">
            ...
            <p>Require quantity for per product: <?php echo $item['material_q'];?></p>
            
            <?php $thisneed= (int)$detail['quantity']*(int)$item['material_q'];?>
            <p>Total need for this order:<?php echo $thisneed;?></p>
            <p>
            <?php if($thisneed<=(int)$item['current_no'])
              echo "satisfy";
            else{
